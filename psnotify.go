...
// Initialize vela-event listener and channels
...
// Close vela-event channels when done message is received
...
// Closes the OS specific vela-event listener,
// removes all watches and closes all vela-event channels.
